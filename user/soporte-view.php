...
<div class="container">
  <div class="row well">
    <div class="col-sm-3">
      <img src="img/logomuni.png" class="img-responsive" width="210" height="100">
    </div>
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de la Municipalidad de Magdalena del Mar</h2>
      <p>Es muy facil de usar, si usted tiene alguna insidencia, nos puede enviar un nuevo ticket, nosotros lo respondemos y solucionaremos su problema.<br>Si ya nos ha enviado un ticket puede consultar el estado de este mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body text-center">
          ...
          <p class="text-justify">Si tienes alguna insidencia reportalo creando un nuevo ticket y te ayudaremos a solucionarlo.Si desea actualizar una peticion ya realizada utiliza el formulario de la derecha <em>Comprobar estado de Ticket</em>, solamente los <strong>usuarios registrados</strong> pueden abrir un nuevo ticket.</p>
    ...
    <div class="col-sm-6">
      <div class="panel panel-danger">
        <div class="panel-heading text-center"><i class="fa fa-link"></i>&nbsp;<strong>Comprobar estado de ultimo Ticket</strong></div>
        <div class="panel-body text-center">
