...
<header class="bg-cyan-400">
  <nav class="mx-auto flex-container max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="#" class="-m-1.5 p-1.5">
        <img class="w-1/2" src="./img/logo_magda.png" alt="">
      </a>
    </div>
    ...
    <?php if(isset($_SESSION['tipo']) && isset($_SESSION['nombre'])): ?>
        <?php if($_SESSION['tipo']=="user"): ?>
            <a href="./index.php?view=ticketusuario"><span class="glyphicon glyphicon-envelope"></span> &nbsp; Mis Tickets</a>                      
        ...
        <?php if($_SESSION['tipo']=="admin" && $_SESSION['cargo']=="tecnico"){ ?>
            ...
            <a href="./index.php?view=registro"><i class="fa fa-users"></i>&nbsp;&nbsp;Registro de nuevos usuarios</a>
